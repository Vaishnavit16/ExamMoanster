...
namespace Webss.Areas.SiteAdminArea.Controllers
{
    [Area("SiteAdminArea")]
    [SiteAdminAuth]
    public class MockTestCategoryController : Controller
    {
        IMockTestCategory repo;
        public MockTestCategoryController(IMockTestCategory repo)
        {
            this.repo = repo;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Create(MockTestCategory rec)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> Edit(MockTestCategory rec)
        {
            if (ModelState.IsValid)
            {
