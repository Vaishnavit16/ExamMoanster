...
namespace Infras.Migrations
{
    ...
    [Migration("20250312150855_kkkkk")]
    partial class kkkkk
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.MockTestQueOption", b =>
                {
                    b.Property<long>("MocktestQueOptionID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("MocktestQueOptionID"));
                    ...
                    b.HasKey("MocktestQueOptionID");

                    b.HasIndex("MockTestQuestionID");

                    b.ToTable("mockTestQueOptions");
                });
            ...
            modelBuilder.Entity("Domain.ScheduleExamDet", b =>
                {
                    ...
                    b.HasOne("Domain.ScheduleExam", null)
                        .WithMany("ScheduleExamDets")
                        .HasForeignKey("ScheduleExamID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.MockTestQuestion", b =>
                {
                    b.Navigation("MockTestQueOptions");
                });
